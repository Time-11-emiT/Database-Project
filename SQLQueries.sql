...
BEGIN	
	SELECT (((SELECT StockPrice FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = p_dateNew) - (SELECT StockPrice FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = p_oldNew)) / (SELECT StockPrice FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = p_dateOld)) * 100 AS percentage_change FROM Market_Data WHERE InvestmentID = p_investmentID AND Date = p_dateNew UNION ALL SELECT (((SELECT StockPrice FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = p_dateNew) - (SELECT StockPrice FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = p_dateOld)) / (SELECT StockPrice FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = p_dateOld)) * 100 AS percentage_change FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = (SELECT StockPrice FROM Market_Data WHERE InvestmentID = p_investmentID AND InvDate = p_dateOld);
END$$
DELIMITER ;
